...
public class MyKafkaContainer extends GenericContainer<MyKafkaContainer> {
  ...
  /**
   * @deprecated use {@link #MyKafkaContainer(DockerImageName)} instead
   */
  @Deprecated
   ...
   */
  @Deprecated
  public MyKafkaContainer(String confluentPlatformVersion) {
    this(DEFAULT_IMAGE_NAME.withTag(confluentPlatformVersion));
  }

  public MyKafkaContainer(final DockerImageName dockerImageName) {
    super(dockerImageName);
    dockerImageName.assertCompatibleWith(DEFAULT_IMAGE_NAME);
  }

  @Override
  MyKafkaContainer.KafkaContainerDef createContainerDef() {
    return new MyKafkaContainer.KafkaContainerDef();
  }

  @Override
  MyKafkaContainer.KafkaContainerDef getContainerDef() {
    return (MyKafkaContainer.KafkaContainerDef) super.getContainerDef();
  }

  public MyKafkaContainer withJmx() {
    this.jmxEnabled = true;
    return self();
  }

  public MyKafkaContainer withEmbeddedZookeeper() {
  ...
  public MyKafkaContainer withExternalZookeeper(String connectString) {
    if (this.kraftEnabled) {
      throw new IllegalStateException("Cannot configure Zookeeper when using Kraft mode");
    }
  ...
  public MyKafkaContainer withKraft() {
  ...
  public MyKafkaContainer withClusterId(String clusterId) {
   ...
   * @return this {@link MyKafkaContainer} instance
   */
  public MyKafkaContainer withListener(Supplier<String> listenerSupplier) {
  ...
  private static class KafkaContainerDef extends ContainerDef {
    ...
    void withJmx() {
      // addExposedTcpPort(KAFKA_JMX_PORT);
      addPortBinding(PortBinding.parse(KAFKA_JMX_PORT + ":" + KAFKA_JMX_PORT));
      addEnvVar("KAFKA_JMX_PORT", String.valueOf(KAFKA_JMX_PORT));
    }
